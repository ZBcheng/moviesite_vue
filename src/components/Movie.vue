<template>
    <div id="movie">
        ...
        <video style="width: 80%; height: 80%; margin-top: 3%" controls="controls">
            <source style="width: 320px" :src="movieUrl" type="video/mp4">
        </video>
    </div>
...
<script>
    export default {
        data() {
            return {
                movieUrl: this.$route.query.url,
                current_user: this.$route.query.user
            }
        },
        methods: {
            back2Index() {
